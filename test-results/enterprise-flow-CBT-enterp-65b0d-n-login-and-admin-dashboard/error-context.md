...
```yaml
- navigation:
  - text: CBT Pro Welcome, School Administrator
  - button "Logout"
- main:
  - paragraph: Completed Exams
  - paragraph: "0"
  - paragraph: Pending Exams
  - paragraph: "0"
  - paragraph: Passed Exams
  - paragraph: "0"
  - paragraph: Average Score
  - paragraph: 0%
  - heading "Available Exams" [level=2]
  - paragraph: No exams available yet
- alert
```
