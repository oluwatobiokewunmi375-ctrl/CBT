...
- Location: tests-e2e\enterprise-flow.spec.ts:30:3
...
Expected pattern: /\/super-admin\/dashboard|\/admin\/dashboard|\/dashboard/
...
```yaml
- text: CBT System Access
- paragraph: Use Student ID login for exam access. Use Dashboard login only if you are a school or system administrator.
- button "Dashboard Access"
- button "Student Exam"
- text: Email Address
- textbox "you@example.com": superadmin@test.com
- text: Password
- textbox "••••••••": admin123
