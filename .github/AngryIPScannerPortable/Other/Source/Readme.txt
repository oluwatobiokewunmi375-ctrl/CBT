...
user in an INI file next to AngryIPScannerPortable.exe called AngryIPScannerPortable.ini.
...
copy AppNamePortable.ini from this directory to AngryIPScannerPortable.ini next to
AngryIPScannerPortable.exe. The options in the INI file are as follows:
